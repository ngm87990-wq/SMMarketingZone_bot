...
def handle_all(message):
    ...
    # বাকি বাটনগুলো আগের মতোই থাকবে...
        ...
        bot.send_message(uid, "🕒 **ডেডলাইন:** প্রতিদিন সকাল ১০টা - রাত ১০টা।", parse_mode="Markdown")

    elif text == '🍂 Work App 🍁':
        bot.send_message(uid, "📲 অ্যাপ ডাউনলোড লিঙ্ক: [এখানে ক্লিক করুন](https://t.me/WorkAppSM)", parse_mode="Markdown")

    elif text == '🆘 Helps 🆘':
        bot.send_message(uid, "🆘 যেকোনো প্রয়োজনে যোগাযোগ করুন:@SMMarketingZone_Supportbot ")
